subroutine compute_laplacian( u, Lu )
! Computes the Laplacian Lu of the scalar field u.

  use constants, only:             n, nsubz, rank
  use legendre, only:              D, D2
  use mesh_deformation_maps, only: d_eta_to_laplacian, d_etaeta_to_laplacian, &
  ...
  ! 1st derivative in eta for the cross term. (this is a folded iterated matvec).
