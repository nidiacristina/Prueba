function data = smpm_read_inputfile( input_file_name )
% data = smpm_read_fieldfile( field_file_name )
%
% Reads the contents of the input file used by the SMPM solver code.
%
% Takes 1 argument:
%
...
% Returns 1 value:
%
%   data - Structure containing all variables set by the input file.  All
