function [Pal] = compute_palinstrophy(data)
...
% Returns 1 value:
%   
%   Pal     - Escalar resulting from palinstrophy computation
%
%
% Jul 2018
% NCRG
...
% Compute the gradient of the vorticity
[dvor_x, dvor_y, dvor_z ] = smpm_compute_gradient( vorty, n, mx, my, mz, x, y, z);
ff=dvor_x.^2+dvor_y.^2+dvor_z.^2;        %Discrete function to be integrated
