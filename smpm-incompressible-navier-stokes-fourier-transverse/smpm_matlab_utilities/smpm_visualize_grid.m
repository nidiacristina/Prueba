function h = smpm_visualize_grid( varargin )
% h = smpm_visualize_grid( mesh_file_name[, h] )
% h = smpm_visualize_grid( n, mx, mz, x, z[, h] )
% h = smpm_visualize_grid( data.grid[, h] );
%
% Generate a visualization of a meshfile that plots all subdomain and external
% interfaces and the GLL points.
%
% Takes 2 arguments:
%
