...
n     = 4;     % The number of GLL points per direction per element.
nsubx = 2;    % The number of x elements.
nsuby = 64;    % The number of y elements.
nsubz = 2;    % The number of z elements.
