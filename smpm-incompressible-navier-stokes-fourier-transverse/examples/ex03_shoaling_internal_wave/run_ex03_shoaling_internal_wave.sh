#!/bin/bash
#
# This is a script to run the shoaling internal wave test case.

# 8 June 2015.
# Sumedh Joshi

# Set some file names.
fname_in="dongsha_in"    # The name of the input file.
tag_out="dongsha"       # All files generated will have this as a prefix.
