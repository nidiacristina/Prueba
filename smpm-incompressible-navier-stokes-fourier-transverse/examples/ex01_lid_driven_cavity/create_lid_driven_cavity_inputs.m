function [input_file_name, inputs] = create_lid_driven_cavity_inputs()
% [input_file_name, inputs] = create_lid_driven_cavity_inputs()
%
% Generates the input and initial condition files to run a small 2D lid driven
% cavity.  Both files are created within the current directory.
%
% Takes no arguments.
%
% Returns 2 values:
...
% Set the initial x-velocity zero everywhere except at the top of the cavity
% which is the moving lid.
ux0          = zeros( n * n * nsubx * nsubz, nsuby );
