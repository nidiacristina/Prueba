#!/bin/bash
#
# This is a script to run the tank-scale internal wave test case.

# 8 June 2015.
# Sumedh Joshi

# Set some file names.
fname_in="tankscale_wave_with_bg_in"    # The name of the input file.
tag_out="tankscale_wave_with_bg"        # All files generated will have this as a prefix.
