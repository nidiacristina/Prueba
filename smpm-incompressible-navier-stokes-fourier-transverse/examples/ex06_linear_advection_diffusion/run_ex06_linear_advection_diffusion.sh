#!/bin/bash
#
# This is a script to run the lock exchange test case.

# 8 June 2015.
# Sumedh Joshi

# Set some file names.
fname_in="linear_advection_diffusion_in" # The name of the input file.
tag_out="linear_advection_diffusion"     # All files generated will have this as a prefix.

# Set the number of MPI ranks and threads.
nranks=4   # Number of MPI ranks.
